...
def global_link(request):
    ...
    return {'links': link_data, 'links_position': link_bar_position, 'links_justify': link_bar_justify, 'links_bgcolor': link_bar_bgcolor, 'links_bgimage_url': link_bar_bgimage_url}